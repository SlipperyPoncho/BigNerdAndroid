...
class PhotoGalleryFragment : VisibleFragment() {
        ...
        searchView.apply {
            setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                override fun onQueryTextSubmit(query: String?): Boolean {
                    ...
                    if (query != null) photoGalleryViewModel.fetchPhotos(query)
                    return true
                }
            ...
            R.id.menu_item_toggle_polling -> {
                ...
                if (isPolling) {
                    ...
                    val periodicRequest = PeriodicWorkRequest
                            ...
                            .build()
                    WorkManager.getInstance().enqueueUniquePeriodicWork(POLL_WORK, ExistingPeriodicWorkPolicy.KEEP,
                        periodicRequest)
    ...
    private inner class PhotoHolder(itemImageView: ImageView) : RecyclerView.ViewHolder(itemImageView), View.OnClickListener {
        ...
        fun bindGalleryItem(item: GalleryItem) { galleryItem = item }
